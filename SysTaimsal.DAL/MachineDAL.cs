...
namespace SysTaimsal.DAL
{
    public class MachineDAL
    {
        ...
        //            //var machine = await DbContext.Machines.FirstOrDefaultAsync(s => s.);
        ...
        //        if (!string.IsNullOrWhiteSpace(pMachine.DescriptionMachine))
        //            pQuery = pQuery.Where(s => s.DescriptionMachine.Contains(pMachine.DescriptionMachine));
        //        if (pMachine.Price > 0)
